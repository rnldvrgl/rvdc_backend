...
from sales.api.views import SalesTransactionViewSet, StallMonthlySheetViewSet
...
router.register(r"monthly-sheets", StallMonthlySheetViewSet, basename="sales-monthly-sheet")
