...
#
# Cron runs using Philippine Time regardless of server timezone.
# Server timezone may be US/Eastern (EST/EDT), UTC, etc.
# ============================================================================
...
# Friday 11:00 PM - Fix attendance & refresh payroll
...
# Sunday 3:30 AM - Cleanup unused images
...
# 2nd day of month, 3:00 AM
0 3 2 * * find /var/log/cron-*.log -type f -mtime +90 -delete
...
# Daily 5:00 AM - Truncate large logs
0 5 * * * /opt/cron-scripts/truncate-large-logs.sh

# Daily 6:00 AM - Disk usage check
...
echo "1. Verify cron timezone: crontab -l | head"
